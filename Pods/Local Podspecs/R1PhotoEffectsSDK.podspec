Pod::Spec.new do |s|
  ...
  s.xcconfig  =  { 'LIBRARY_SEARCH_PATHS' => '"$(PODS_ROOT)/R1PhotoEffectsSDK/R1PhotoEffectsSDK-ios-1.0.4 2"' }
  s.pre_install do |pod, library_representation|
    Dir.chdir(File.join(pod.root, 'R1PhotoEffectsSDK-ios-1.0.4 2')) { `mv R1PhotoEffectsSDK.a libR1PhotoEffectsSDK.a` }
  end
end
